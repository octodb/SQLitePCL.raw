...
namespace SQLitePCL
{
    ...
    public sealed class SQLite3Provider_LiteSync : ISQLite3Provider
    {
		const string NATIVE_LIBRARY_NAME = "litesync";
...
// TODO obsolete.  just throw?
	...
	{
        private const string SQLITE_DLL = NATIVE_LIBRARY_NAME;
